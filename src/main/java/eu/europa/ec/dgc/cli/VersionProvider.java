...
public class VersionProvider implements CommandLine.IVersionProvider {
    ...
    private static final String dgcCliVersionProperty = "Implementation-Version";
    private static final String dgcLibVersionProperty = "dgc-lib-version";

    @Override
    public String[] getVersion() throws Exception {
        InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream(manifestPath);
