...
@CommandLine.Command(
    ...
    description = "Calculates a signature for a File."
)
public class SignFile implements Callable<Integer> {

    @CommandLine.Option(
        names = {"--inputFile", "-i"},
        description = "Input file you want to sign.",
        required = true
    )
    ...
    @CommandLine.Option(
        names = {"--outputFile", "-o"},
        description = "The file where to write the signature to.",
        required = true
    )
    ...
    public Integer call() throws Exception {
        ...
        String signedMessaged = new SignedByteArrayMessageBuilder()
